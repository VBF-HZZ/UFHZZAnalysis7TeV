...
// 
/*
  class UFHZZ4LAna UFHZZ4LAna.cc UFHZZAnalysis7TeV/UFHZZ4LAna/src/UFHZZ4LAna.cc
  
  Description: UF HZZ4L Analysis Analyzer. Works in CMSSW 44X
...
//Angles
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LAngles.h"
...
//Helper
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LHelper.h"
//Muons
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LMuonAna.h"
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LMuonTree.h"
//Electrons
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LElectronTree.h"
//Photons
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LPhotonTree.h"
//Jets
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LJetTree.h"
//Final Leps
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LFinalLepTree.h"
//Sip
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LSipAna.h"
//PU
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LPileUp.h"
#include "PhysicsTools/Utilities/interface/LumiReWeighting.h"
#include "SimDataFormats/PileupSummaryInfo/interface/PileupSummaryInfo.h"
//Iso
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LIsoEff.h"
//Mass Error
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LMassErr.h"
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LPerLepResolution.h"
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LDiLepResolution.h"
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LResolution.h"

//Signal Efficiency
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LSigEff.h"
//Z->4L
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LZto4LAna.h"
//GEN
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LGENAna.h"
//VBF Jets
#include "UFHZZAnalysis7TeV/UFHZZ4LAna/interface/HZZ4LJets.h"
...
private:
  ...
  void setTreeVariables( const edm::Event&, const edm::EventSetup&, 
			 std::vector<pat::Muon> selectedMuons, std::vector<pat::Electron> selectedElectrons, std::vector<pat::Jet> selectedVBFJets);
...
UFHZZ4LAna::UFHZZ4LAna(const edm::ParameterSet& iConfig) :
  ...
  PUVersion(iConfig.getUntrackedParameter<std::string>("PUVersion","HCP44X")),
  ...
  bStudyFourLeptonResolution(iConfig.getUntrackedParameter<bool>("bStudyFourLeptonResolution",false))
{
  ...
  //else{ lumiWeight = new edm::LumiReWeighting( "UFHZZAnalysis7TeV/UFHZZ4LAna/hists/mcFlat10_Fall11.root", "UFHZZAnalysis7TeV/UFHZZ4LAna/hists/Data_PU_Fall11.root",
  //					       "pileup_mc", "pileup" ); } 
  ...
  //mela = new Mela(false,7);
  MEMsnoPDFs_noFSR = new MEMs(7);
  MEMsnoPDFs = new MEMs(7);
...
UFHZZ4LAna::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if( notDuplicateEvent && !vertex->empty()){
	...
	//VBF Jets
	vector<pat::Jet> selectedVBFJets;
	double tempDeltaR = -999;
	if(doVarDump) jetDump->fillJetDumpTree(jets,iEvent);
	...
	for(unsigned int i = 0; i < jets->size(); ++i) 
	  {
		...
		if(jetHelper.patjetID(patjet) == 1) looseIDPass = true;
		...
		if(looseIDPass)
		  {
		    ...
		    if(patjet.pt() > 30 && fabs(patjet.eta()) < 4.7 && isDeltaR)
		      {
	...
	if( passedPtCuts ){
	  ...
	  if(fourLep_Cleaned){
	    ...
	    setTreeVariables(iEvent, iSetup, selectedMuons, selectedElectrons, selectedVBFJets);
...
{     
  ...
  //tree->Branch("massErrorUFADCorr",&m4lErrUFADCorr,"massErrorUFADCorr/D");
				   ...
				   std::vector<pat::Muon> selectedMuons, std::vector<pat::Electron> selectedElectrons, std::vector<pat::Jet> selectedVBFJets)
{
  ...
  if( RecoFourMuEvent )
    {
      ...
      mvaL1 = selectedMuons[0].userInt("pfMuId");
      ...
      mvaL2 = selectedMuons[1].userInt("pfMuId");
      ...
      mvaL3 = selectedMuons[2].userInt("pfMuId");
      ...
      mvaL4 = selectedMuons[3].userInt("pfMuId");
  ...
  else if( RecoTwoETwoMuEvent )
    {
      ...
      mvaL3 = selectedMuons[0].userInt("pfMuId");
      ...
      mvaL4 = selectedMuons[1].userInt("pfMuId");
  ...
  else if( RecoTwoMuTwoEEvent )
    {
	  ...
	  mvaL3 = selectedMuons[1].userInt("pfMuId");
	  ...
	  mvaL4 = selectedMuons[2].userInt("pfMuId");
	  ...
	  mvaL4 = selectedMuons[0].userInt("pfMuId");
  ...
  for( unsigned int k = 0; k < selectedVBFJets.size(); k++)
      ...
      if (isDeltaR)
	{
	  ...
	  if (selectedVBFJets[k].pt() > 30 && fabs(selectedVBFJets[k].eta()) < 4.7)
	    {
	      finalVBFJets.push_back(selectedVBFJets[k]);
	    }
  ...
  if(VBFJet2){
    ...
    // MORIOND --- FisherDiscrim = 0.09407*fabs(VBFDeltaEta) + 4.1581e-4*VBFDiJetMass;
