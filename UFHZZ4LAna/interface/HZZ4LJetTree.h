...
class HZZ4LJetTree
{
 ...
 public:
  ...
  void fillJetDumpTree(edm::Handle<edm::View<pat::Jet> > jets, const edm::Event& iEvent);
...
void HZZ4LJetTree::fillJetDumpTree(edm::Handle<edm::View<pat::Jet> >  jets, const edm::Event& iEvent)
{
  ...
  for(unsigned int i = 0; i < jets->size(); ++i) 
    {
      ...
      pfid = JetHelper.patjetID(patjet);
      pT = patjet.pt();
      eta = patjet.eta();
      phi = patjet.phi();
